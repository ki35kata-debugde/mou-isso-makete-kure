window.GAME_DATA = {
      ...
      "demand": [
        {
          ...
          "body": "出陣する。他国の道は狭いらしい。荷車を減らすな。兵糧一万、誤差なく整えよ。\n\n【出立準備依頼】兵糧×5　輸送フェーズで手渡し可"
        },
        {
          "id": "food_node_enter",
          "priority": 100,
        ...
        },
        {
          ...
          "body": "湿地で荷車が沈む。進軍が遅れた。補給量を増やせ。次便は急ぎ届けよ。\n\n【依頼】{{order_label}}　納期：{{deadline}}ターン後"
        },
        {
          ...
          "body": "昨夜数名倒れた。疲労が深い。補給を絶やすな。次便は兵の命を左右する。\n\n【依頼】{{order_label}}　納期：{{deadline}}ターン後"
        },
        {
          ...
          "body": "敵城目前。兵の士気は高い。補給は貴殿の計算が要だ。最後の便を確実に届け。\n\n【依頼】{{order_label}}　納期：{{deadline}}ターン後"
        }
      ],
      "personal": [
        {
    ...
    "siege": {
      "demand": [
        ...
        },
        {
          ...
          "body": "投石機の腕木の反発力が弱い。支点の摩耗が原因だ。支点軸を太くし、鋼板を二枚追加せよ。角度は図面のままでよい。\n\n【依頼】{{order_label}}　納期：{{deadline}}ターン後"
        },
        {
          ...
          "body": "前線で衝角を試した。角度三度の変更は正しかった。衝撃の伝達が均一になり、壁面の亀裂が広がった。次便は鋼板を多めに送れ。試験を続ける。\n\n【依頼】{{order_label}}　納期：{{deadline}}ターン後"
        },
        {
      ...
      "personal": [
        ...
        },
        {
          ...
          "body": "炉子殿。敵城の壁は高い。新型兵器が通用するか、少し緊張している。\nだがここまで来たみんなと一緒であれば勝てる気がする。\n君の父君の兵器と、君の図面と、兵たちの腕で城を落とす。\n都へ戻ったら、君と一緒にたくさん新しい発明をしたい。",
          "choices": [
            {
              "icon": "🤝",
              "text": "「帰還したら新型兵器を一緒に作りましょう」",
              "trust": 2
            },
            {
              "icon": "📝",
      ...
      "demand": [
        {
          ...
          "body": "少数精鋭で行く。剣を二振り頼む。軽くて速いやつだ。薬はいらん。俺は怪我しない。天才だからな。\n\n【出立準備依頼】剣★1×2　輸送フェーズで手渡し可"
        },
        {
        ...
        },
        {
          ...
          "body": "地形が狭い。少数で突く。剣を四振り、急げ。振るのは兵だ。俺は素手でも勝てる。天才だからな。\n\n【依頼】{{order_label}}　納期：{{deadline}}ターン後"
        },
        {
        ...
        },
        {
          ...
          "body": "兵がよく動く。弩と鋼剣を頼む。それと回復薬を多めに。俺のじゃない、兵のだ。\n\n【依頼】{{order_label}}　納期：{{deadline}}ターン後"
        },
        {
          ...
          "body": "敵城目前。剣も鋼剣も、ありったけ寄越せ。俺が早く終わらせる。皆を守るためだ。\n\n【依頼】{{order_label}}　納期：{{deadline}}ターン後"
        }
      ],
      "personal": [
        {
          ...
          "intro": "天才って言い切る人、薬房では初めて見ました",
          "body": "芍薬へ。\n南部の攻略、俺ひとりで十分だ。\n夜に忍び込んで将軍の首を取れば終わる。\nそなたの薬は兵にだけ使わせる。\n俺は怪我しない。天才だからな。",
          "choices": [
            {
              "icon": "💊",
              "text": "「天才でも傷は負います。予備薬を持っていって」",
              "trust": 2
            },
            {
              "icon": "🌿",
        ...
        },
        {
          ...
          "intro": "「天才だからな」二回目…気に入ってますね、その言い方",
          "body": "芍薬へ。\nこの地形、最高だ。\n少数で斜めに突けば敵は崩れる。\n兄上らは来なくていい。俺が全部やる。\nそなたの薬は勝利のあとに兵へ配る。\n俺は使わん。天才だからな（二回目）。",
          "choices": [
            {
              "icon": "💊",
        ...
        },
        {
          ...
          "intro": "薬、使ってくれたんですね…帰ったら叱って、それから褒めます",
          "body": "芍薬へ。\n初めて、そなたの薬を使った。\nよく効いた。\n…怪我ではない。眠るためだ。\n明日で終わらせる。\n帰ったら、礼を言いに行く。俺の口から、直接。",
          "choices": [
            {
              "icon": "🤝",
  ...
  "facility_lines": {
    "market": [
      "いらっしゃいませ。売買の相場は今日も安定しています。薬の売却もお受けします。",
    ...
    "ranch": [
      ...
      "冬は寒いので……兵糧と回復薬、多めにあげたいです。",
      "……回復薬をあげると、生まれてくる仔馬が元気になるそうです。楽しみです。",
      "……馬たちは、みんな家族みたいなものです。",
